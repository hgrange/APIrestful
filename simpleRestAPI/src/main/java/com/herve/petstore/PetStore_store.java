...
public class PetStore_store {
    ...
    public JsonObject findByStatus(@DefaultValue("sold") @QueryParam("status") String status) {
    	    JsonObject jsonObj = null;
    	    String fileName = "PetStoreInventoryStore.json"; ;
			...
			System.out.println("String sFile = "+ sFile );
			URI uri;
			try {
				uri = new URI(sFile);
				...
				System.out.println("java.nio.file.Path path = " + path.toString());
